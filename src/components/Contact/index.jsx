    ...
    return (
        <>
                ...
                <div className={styles.body}>
                    <div className={styles.title}>
                        ...
                        <motion.div style={{x}} className={styles.buttonContainer}>
                            <Rounded onClick={() => setModalActive(true)} backgroundColor={"#f6ff00"} className={styles.button}>
                                <p>Get in touch</p>
                            </Rounded>
                        </motion.div>
            ...
            <AnimatePresence mode="wait">
                {modalActive && <ContactModal active={modalActive} setActive={setModalActive} />}
            </AnimatePresence>
        </>
    )
}